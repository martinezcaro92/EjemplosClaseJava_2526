...
/**
 * Subbloque 3.4 - Ejercicio 4
 * Base de datos de plataforma de cursos online (BD: plataforma_cursos)
...
public class Ejercicio4 {
    ...
    private static final String NOMBRE_BD    = "plataforma_cursos";
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Base de datos 'plataforma_cursos' generada correctamente.");
    }
}
