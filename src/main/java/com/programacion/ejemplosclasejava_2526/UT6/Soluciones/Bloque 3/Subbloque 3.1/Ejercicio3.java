...
/**
 * Subbloque 3.1 - Ejercicio 3
 * Preparación del esquema de gestión hotelera (BD: hotel)
...
public class Ejercicio3 {
    ...
    public static void main(String[] args) {
        ...
        try (Connection connBD = conectarBaseDeDatos(nombreBD)) {
            ...
            System.out.println("Esquema de 'hotel' generado correctamente.");
        } catch (SQLException e) {
