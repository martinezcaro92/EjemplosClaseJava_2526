...
/**
 * Subbloque 4.1 - Ejercicio 3
 * Carga de clientes desde CSV a hotel
 * BD: hotel, tabla destino: cliente_hotel
...
public class Ejercicio3 {
        ...
        try {
            ...
            while (scan.hasNextLine()) {
                ...
                String sql = String.format(
                    "INSERT INTO cliente_hotel (...) VALUES ('%s','%s')", campo1, campo2);
                try (Connection conn = DriverManager.getConnection(URL, USER, PASSWORD)) {
                    conn.createStatement().executeUpdate(sql);
                    System.out.println("Registro insertado en cliente_hotel.");
                    insertados++;
    ...
    public static void main(String[] args) {
        cargarDesdeCSV("src\\main\\java\\com\\programacion\\ejemplosclasejava_2526\\UT6\\Bloque 4\\Subbloque 4.1\\clientes_hotel.csv");
    }
}
