...
/**
 * Subbloque 1.2 - Ejercicio 4

 * Catálogo de videojuegos (JSON — versión CSV simplificada)
 * Campos: titulo, plataforma, desarrollador, anio
...
public class Ejercicio4 {
    ...
    public static void main(String[] args) {
        ...
        String fullName = "src\\main\\java\\com\\programacion\\ejemplosclasejava_2526\\UT6\\Bloque 1\\Subbloque 1.2\\videojuegos.csv";
