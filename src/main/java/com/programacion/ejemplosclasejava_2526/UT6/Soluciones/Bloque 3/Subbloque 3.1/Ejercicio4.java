...
/**
 * Subbloque 3.1 - Ejercicio 4
 * Preparación del esquema de instituto educativo (BD: instituto)
...
public class Ejercicio4 {
    ...
    public static void main(String[] args) {
        ...
        try (Connection connBD = conectarBaseDeDatos(nombreBD)) {
            ...
            System.out.println("Esquema de 'instituto' generado correctamente.");
        } catch (SQLException e) {
