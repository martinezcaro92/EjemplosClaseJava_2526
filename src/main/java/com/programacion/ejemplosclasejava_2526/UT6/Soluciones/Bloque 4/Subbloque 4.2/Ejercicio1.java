...
/**
 * Subbloque 4.2 - Ejercicio 1
 * Exportación del inventario de tienda_online a CSV.
 */
public class Ejercicio1 {
    ...
    public static void exportarACSV(String fullName) {
    ...
    public static void main(String[] args) {
        exportarACSV("src\\main\\java\\com\\programacion\\ejemplosclasejava_2526\\UT6\\Bloque 4\\Subbloque 4.2\\inventario_exportado.csv");
    }
}
