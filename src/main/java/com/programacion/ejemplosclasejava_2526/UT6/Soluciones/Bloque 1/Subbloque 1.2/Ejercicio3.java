...
/**
 * Subbloque 1.2 - Ejercicio 3
 * Control de asistencia de empleados (CSV)
 * Campos: empleado_id, nombre, fecha, hora_entrada, hora_salida
...
public class Ejercicio3 {
    ...
    public static void main(String[] args) {
        String fullName = "src\\main\\java\\com\\programacion\\ejemplosclasejava_2526\\UT6\\Bloque 1\\Subbloque 1.2\\asistencia.csv";
