-- DATOS DE PARTIDA para todos los ejercicios del SB3.5
-- Ejecutar este script ANTES de los ejercicios para tener datos que exportar.
-- Crea/recrea las BDs: tienda_online, instituto, hotel, personas, red_bibliotecas
...
INSERT INTO cliente (nombre, email) VALUES ('Ana Garcia','ana@shop.com'),('Luis Perez','luis@correo.es'),('Marta Sanz','marta@email.net'),('David Ruiz','david@web.com'),('Carmen Lopez','carmen@tienda.es');
...
INSERT INTO pedido (id_cliente, id_producto, cantidad, fecha) VALUES (1,1,1,'2025-01-10'),(2,3,2,'2025-01-11'),(3,2,1,'2025-01-13'),(4,4,1,'2025-01-14'),(5,7,3,'2025-01-15'),(1,2,1,'2025-01-18');
...
INSERT INTO profesor (nombre, especialidad) VALUES ('Maria Lopez','Informatica'),('Juan Martinez','Matematicas');
INSERT INTO asignatura (nombre, id_profesor) VALUES ('Programacion',1),('Bases de Datos',1),('Matematicas',2);
...
INSERT INTO matricula (id_alumno, id_asignatura) VALUES (1,1),(1,2),(2,1),(3,1),(3,2),(4,3),(5,1),(6,2);
...
INSERT INTO cliente_hotel (nombre, dni) VALUES ('Ana Garcia','12345678A'),('Luis Perez','87654321B'),('Marta Sanz','11223344C'),('David Ruiz','44332211D');
INSERT INTO reserva (id_cliente, num_habitacion, fecha_entrada, fecha_salida) VALUES (1,201,'2025-02-14','2025-02-17'),(2,101,'2025-03-01','2025-03-05'),(3,301,'2025-03-10','2025-03-12'),(4,102,'2025-04-20','2025-04-25');
