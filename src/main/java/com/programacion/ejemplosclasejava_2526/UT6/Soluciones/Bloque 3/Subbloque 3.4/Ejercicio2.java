...
/**
 * Subbloque 3.4 - Ejercicio 2
 * Base de datos de red de bibliotecas (BD: red_bibliotecas)
...
public class Ejercicio2 {
    ...
    private static final String NOMBRE_BD    = "red_bibliotecas";
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Base de datos 'red_bibliotecas' generada correctamente.");
    }
}
