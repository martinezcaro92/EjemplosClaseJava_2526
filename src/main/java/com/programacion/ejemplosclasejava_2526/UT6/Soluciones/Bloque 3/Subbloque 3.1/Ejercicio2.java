...
/**
 * Subbloque 3.1 - Ejercicio 2
 * Preparación del esquema de tienda online (BD: tienda_online)
...
public class Ejercicio2 {
    ...
    public static void main(String[] args) {
        ...
        try (Connection connBD = conectarBaseDeDatos(nombreBD)) {
            ...
            System.out.println("Esquema de 'tienda_online' generado correctamente.");
        } catch (SQLException e) {
