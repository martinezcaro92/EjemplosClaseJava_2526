...
/**
 * Subbloque 3.4 - Ejercicio 5
 * Base de datos de parking municipal (BD: parking_municipal)
...
public class Ejercicio5 {
    ...
    private static final String NOMBRE_BD    = "parking_municipal";
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Base de datos 'parking_municipal' generada correctamente.");
    }
}
